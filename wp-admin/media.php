...
switch ($action) {
    case 'editattachment' :
        ...
        if (!current_user_can('edit_post', $attachment_id)) wp_die(__('You are not allowed to edit this attachment.'));
        ...
        if (empty($errors)) {
            ...
            if ($referer = wp_get_original_referer()) {
                if (false !== strpos($referer, 'upload.php') || (url_to_postid($referer) == $attachment_id)) $location = $referer;
            }
    ...
    case 'edit' :
        ...
        if ($message) echo "<div id='message' class='$class'><p>$message</p></div>\n";
