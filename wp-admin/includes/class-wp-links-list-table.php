...
class WP_Links_List_Table extends WP_List_Table {
    ...
    public function __construct($args = array()) {
        parent::__construct(array('plural' => 'bookmarks', 'screen' => isset($args['screen']) ? $args['screen'] : null,));
    }
    ...
    public function prepare_items() {
        ...
        if ('all' != $cat_id) $args['category'] = $cat_id;
        if (!empty($s)) $args['search'] = $s;
    ...
    protected function extra_tablenav($which) {
        ...
        <div class="alignleft actions">
            <?php
            $dropdown_options = array('selected' => $cat_id, 'name' => 'cat_id', 'taxonomy' => 'link_category', 'show_option_all' => __('All categories'), 'hide_empty' => true, 'hierarchical' => 1, 'show_count' => 0, 'orderby' => 'name',);
                    ...
                    switch ($column_name) {
                        ...
                        case 'categories':
                            ...
                            foreach ($link->link_category as $category) {
                                ...
                                if (is_wp_error($cat)) echo $cat->get_error_message();
                                $cat_name = $cat->name;
                                if ($cat_id != $category) $cat_name = "<a href='link-manager.php?cat_id=$category'>$cat_name</a>";
                                $cat_names[] = $cat_name;
                            }
