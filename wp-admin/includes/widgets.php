...
function wp_list_widgets() {
    ...
    foreach ($sort as $widget) {
        ...
        if (!isset($widget['params'][0])) $widget['params'][0] = array();
...
function wp_widget_control($sidebar_args) {
    ...
    if (isset($sidebar_args['_display']) && 'template' == $sidebar_args['_display'] && $widget_number) {
        ...
        if (isset($control['id_base'])) $id_format = $control['id_base'] . '-__i__';
    }
    ...
    <div class="widget-inside">
        <form method="post">
            <div class="widget-content">
                <?php
                if (isset($control['callback'])) $has_form = call_user_func_array($control['callback'], $control['params']); else
