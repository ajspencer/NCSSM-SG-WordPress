...
if (!current_user_can('manage_sites')) wp_die(__('You do not have sufficient permissions to manage themes for this site.'));
...
if ($action) {
    ...
    switch ($action) {
        case 'enable':
            ...
            $action = 'enabled';
            $n = 1;
            if (!$allowed_themes) $allowed_themes = array($theme => true); else
        ...
        case 'disable':
            ...
            $action = 'disabled';
            $n = 1;
            if (!$allowed_themes) $allowed_themes = array(); else
