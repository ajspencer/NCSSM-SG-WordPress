...
if (!current_user_can('create_users')) wp_die(__('You do not have sufficient permissions to add users to this network.'));
...
if (isset($_REQUEST['action']) && 'add-user' == $_REQUEST['action']) {
    ...
    if (!is_array($_POST['user'])) wp_die(__('Cannot create an empty user.'));
...
if (isset($_GET['update'])) {
    $messages = array();
    if ('added' == $_GET['update']) $messages[] = __('User added.');
}
