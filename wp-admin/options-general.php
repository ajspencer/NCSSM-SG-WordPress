...
get_current_screen()->set_help_sidebar('<p><strong>' . __('For more information:') . '</strong></p>' . '<p>' . __('<a href="https://codex.wordpress.org/Settings_General_Screen" target="_blank">Documentation on General Settings</a>') . '</p>' . '<p>' . __('<a href="https://wordpress.org/support/" target="_blank">Support Forums</a>') . '</p>');
...
<div class="wrap">
        ...
        <table class="form-table">
            ...
            <?php } else { ?>
                <tr>
                    ...
                    <td><input name="new_admin_email" type="email" id="new_admin_email"
                        ...
                        <p class="description"
                           id="new-admin-email-description"><?php _e('This address is used for admin purposes. If you change this we will send you an e-mail at your new address to confirm it. <strong>The new address will not become active until confirmed.</strong>') ?></p>
                        <?php
            ...
            <tr>
                ...
                if (empty($tzstring)) { // Create a UTC+- zone if no timezone string exists
                    ...
                    if (0 == $current_offset) $tzstring = 'UTC+0'; elseif ($current_offset < 0) $tzstring = 'UTC' . $current_offset;
                    else
    ...
    if ($now['tm_isdst']) _e('This timezone is currently in daylight saving time.'); else
