...
!function (a, b) {
  adminMenu = {
    ...
    B.on("click.wp-submenu-head", ".wp-submenu-head", function (b) {
      ...
      c(a(this))
    })), p = a("div.wrap h2:first"), p.nextAll("div.updated, div.error, div.notice").addClass("below-h2"), a("div.updated, div.error, div.notice").not(".below-h2, .inline").insertAfter(p), a(".notice.is-dismissible").each(function () {
    ...
    }, "td.post-title, td.title, td.comment, .tags td.column-name, .bookmarks td.column-name, td.blogname, .users-network td.column-blogs, td.username, .dashboard-comment-wrap"), a("#default-password-nag-no").click(function () {
