...
!function (a) {
  findPosts = {
    open: function (b, c) {
      ...
      c.addClass("is-active"), a.ajax(ajaxurl, {type: "POST", data: b, dataType: "json"}).always(function () {
    ...
    c.length && window.wp && window.wp.media && (b = _wpMediaGridSettings, window.wp.media({
      frame: "manage",
      container: c,
      library: b.queryVars
