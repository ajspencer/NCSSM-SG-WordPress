  ...
  b = wpNavMenu = {
    ...
    initAccessibility: function () {
      ...
      b.refreshKeyboardAccessibility(), b.refreshAdvancedAccessibility(), c.on("mouseenter.refreshAccessibility focus.refreshAccessibility touchstart.refreshAccessibility", ".menu-item", function () {
        b.refreshAdvancedAccessibilityOfItem(a(this).find(".item-edit"))
      }), c.on("click", ".item-edit", function () {
        b.refreshAdvancedAccessibilityOfItem(a(this))
      }), c.on("click", ".menus-move", function (c) {
        var d = a(this), e = d.data("dir");
    ...
    refreshAdvancedAccessibilityOfItem: function (b) {
      if (!0 === a(b).data("needs_accessibility_refresh")) {
        var c, d, e, f, g, h, i, j, k, l = a(b), m = l.closest("li.menu-item").first(), n = m.menuItemDepth(), o = 0 === n, p = l.closest(".menu-item-handle").find(".menu-item-title").text(), q = parseInt(m.index(), 10), r = o ? n : parseInt(n - 1, 10), s = m.prevAll(".menu-item-depth-" + r).first().find(".menu-item-title").text(), t = m.prevAll(".menu-item-depth-" + n).first().find(".menu-item-title").text(), u = a("#menu-to-edit li").length, v = m.nextAll(".menu-item-depth-" + n).length;
    ...
    refreshAdvancedAccessibility: function () {
      a(".menu-item-settings .field-move a").hide(), a(".item-edit").data("needs_accessibility_refresh", !0), a(".menu-item-edit-active .item-edit").each(function () {
      ...
      a(".item-edit").off("focus").on("focus", function () {
        a(this).off("keydown").on("keydown", function (c) {
          ...
          if ((37 == c.which || 38 == c.which || 39 == c.which || 40 == c.which) && (e.off("keydown"), 1 !== a("#menu-to-edit li").length)) {
            switch (d = {38: "up", 40: "down", 37: "left", 39: "right"}, a("body").hasClass("rtl") && (d = {
              38: "up",
              40: "down",
              39: "left",
              37: "right"
    ...
    addCustomLink: function (c) {
      ...
      return c = c || b.addMenuItemToBottom, "" === d || "http://" == d ? !1 : (a(".customlinkdiv .spinner").addClass("is-active"), void this.addLinkToMenu(d, e, c, function () {
    ...
    removeMenuItem: function (c) {
      ...
      c.addClass("deleting").animate({opacity: 0, height: 0}, 350, function () {
