...
class AtomParser {
    ...
    function start_element($parser, $name, $attrs) {
        ...
        if (!empty($this->in_content)) {
            ...
            if ($this->is_html || $this->is_text) trigger_error("Invalid content in element found. Content must not be of type text or html if it contains markup.");
    ...
    function end_element($parser, $name) {
        ...
        if (!empty($this->in_content)) {
            ...
            if ($this->in_content[0][0] == $tag && $this->in_content[0][1] == $this->depth) {
                ...
                $this->in_content = array();
            } else if ($this->in_content[$ccount - 1][0] == $tag && $this->in_content[$ccount - 1][1] == $this->depth) {
