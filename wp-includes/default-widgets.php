...
class WP_Widget_Links extends WP_Widget {
    ...
    public function update($new_instance, $old_instance) {
        ...
        foreach ($instance as $field => $val) {
            if (isset($new_instance[$field])) $instance[$field] = 1;
        }

        $instance['orderby'] = 'name';
        if (in_array($new_instance['orderby'], array('name', 'rating', 'id', 'rand'))) $instance['orderby'] = $new_instance['orderby'];
...
class WP_Widget_Text extends WP_Widget {
    ...
    public function update($new_instance, $old_instance) {
        $instance = $old_instance;
        $instance['title'] = strip_tags($new_instance['title']);
        if (current_user_can('unfiltered_html')) $instance['text'] = $new_instance['text']; else
...
class WP_Widget_Recent_Comments extends WP_Widget {
    ...
    public function __construct() {
        ...
        if (is_active_widget(false, false, $this->id_base)) add_action('wp_head', array($this, 'recent_comments_style'));
...
class WP_Widget_RSS extends WP_Widget {
    ...
    public function widget($args, $instance) {
        ...
        if ($title) $title = "<a class='rsswidget' href='$url'><img style='border:0' width='14' height='14' src='$icon' alt='RSS' /></a> <a class='rsswidget' href='$link'>$title</a>";
