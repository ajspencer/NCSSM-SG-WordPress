...
!function (e, t) {
  ...
  r(l, [], function () {
    ...
    function y(e) {
      for (var t, n, r, i = e.length, o = w.relative[e[0].type], a = o || w.relative[" "], s = o ? 1 : 0, l = p(function (e) {
        ...
        if (n = w.filter[e[s].type].apply(null, e[s].matches), n[F]) {
          ...
          return v(s > 1 && h(u), s > 1 && f(e.slice(0, s - 1).concat({value: " " === e[s - 2].type ? "*" : ""})).replace(se, "$1"), n, r > s && y(e.slice(s, r)), i > r && y(e = e.slice(r)), i > r && f(e))
        }
        u.push(n)
      }
      return h(u)
    ...
    var C, x, w, _, E, N, k, S, T, R, A, B, D, L, M, H, P, O, I, F = "sizzle" + -new Date, z = window.document, W = 0, V = 0, U = n(), $ = n(), q = n(), j = function (e, t) {
      return e === t && (A = !0), 0
    }, Y = typeof t, K = 1 << 31, G = {}.hasOwnProperty, X = [], J = X.pop, Q = X.push, Z = X.push, ee = X.slice, te = X.indexOf || function (e) {
    ...
    var e = navigator, t = e.userAgent, n, r, i, o, a, s, l, c, u;
    ...
    return function (a) {
      ...
      function v(t, n, r) {
        ...
        function l(e, r, o) {
          ...
          l = d.inline || d.block, f = U.create(l), i(f), q.walk(e, function (e) {
            function r(e) {
              var g, v, y, b, x;
              return x = p, g = e.nodeName.toLowerCase(), v = e.parentNode.nodeName.toLowerCase(), 1 === e.nodeType && ne(e) && (x = p, p = "true" === ne(e), b = !0), S(g, "br") ? (h = 0, void(d.block && U.remove(e))) : d.wrapper && C(e, t, n) ? void(h = 0) : p && !b && d.block && !d.wrapper && s(g) && j(v, l) ? (e = U.rename(e, l), i(e), a.push(e), void(h = 0)) : d.selector && (ae(u, function (t) {
                "collapsed"in t && t.collapsed !== m || U.is(e, t.selector) && !c(e) && (i(e, t), y = !0)
              }), !d.inline || y) ? void(h = 0) : void(!p || b || !j(l, g) || !j(v, l) || !o && 3 === e.nodeType && 1 === e.nodeValue.length && 65279 === e.nodeValue.charCodeAt(0) || c(e) || d.inline && Y(e) ? (h = 0, ae(se(e.childNodes), r), b && (p = x), h = 0) : (h || (h = U.clone(f, Q), e.parentNode.insertBefore(h, e), a.push(h)), h.appendChild(e)))
            }
            ...
            function o(e) {
              ...
              }), t && !oe(t) && k(t, d) && (n = U.clone(t, Q), i(n), U.replace(n, e, Z), U.remove(t, 1)), n || e
            }
        ...
        if (d)if (r)r.nodeType ? (h = U.createRng(), h.setStartBefore(r), h.setEndAfter(r), l(L(h, u), null, !0)) : l(r, null, !0); else if (m && d.inline && !U.select("td.mce-item-selected,th.mce-item-selected").length)z("apply", t, n); else {
          ...
          K || !u[0].defaultBlock || U.getParent(y, U.isBlock) || v(u[0].defaultBlock), a.selection.setRng(o()), p = $.getBookmark(), l(L($.getRng(Z), u), p), d.styles && (d.styles.color || d.styles.textDecoration) && (le(y, g, "childNodes"), g(y)), $.moveToBookmark(p), W($.getRng(Z)), a.nodeChanged()
        }
      }
      ...
      function y(e, t, n, r) {
        ...
        function u(e) {
          ...
          return oe(n) && (n = n[e ? "firstChild" : "lastChild"]), 3 == n.nodeType && 0 === n.data.length && (n = e ? t.previousSibling || t.nextSibling : t.nextSibling || t.previousSibling), U.remove(t, !0), n
        }
      ...
      function H(e, t, n, r) {
        ...
        }), a && "" === U.getAttrib(n, "style") && (n.removeAttribute("style"), n.removeAttribute("data-mce-style")), ae(e.attributes, function (e, i) {
          var o;
          if (e = A(e, t), "number" == typeof i && (i = e, r = 0), !r || S(U.getAttrib(r, i), e)) {
            if ("class" == i && (e = U.getAttrib(n, i), e && (o = "", ae(e.split(/\s+/), function (e) {
                /mce\-\w+/.test(e) && (o += (o ? " " : "") + e)
      ...
      function P(e, t) {
        ...
        t.block && (K ? r == U.getRoot() && (t.list_block && S(e, t.list_block) || ae(se(e.childNodes), function (e) {
      ...
      function I(e, t) {
        ...
        if (e && t && (e = n(e, "previousSibling"), t = n(t, "nextSibling"), a.compare(e, t))) {
          ...
          return U.remove(t), ae(se(t.childNodes), function (t) {
            e.appendChild(t)
          }), e
        }
        return t
      ...
      function z(t, n, r, i) {
        ...
        function m() {
          var e;
          e = c($.getStart()), e && !U.isEmpty(e) && le(e, function (e) {
      ...
      var V = {}, U = a.dom, $ = a.selection, q = new t(U), j = a.schema.isValidChild, Y = U.isBlock, K = a.settings.forced_root_block, G = U.nodeIndex, X = "\ufeff", J = /^(src|href|style)$/, Q = !1, Z = !0, ee, te, ne = U.getContentEditable, re, ie, oe = n.isBookmarkNode, ae = i.each, se = i.grep, le = i.walk, ce = i.extend;
      ce(this, {
        get: f,
        register: p,
        unregister: h,
    ...
    return function (s) {
      ...
      function h() {
        ...
        var g = s.getDoc(), v = s.dom, y = s.selection, b = window.MutationObserver, C, x;
        b || (C = !0, b = function () {
          function e(e) {
          ...
          !u(e) && e.clipboardData && (e.preventDefault(), e.clipboardData.clearData(), e.clipboardData.setData("text/html", s.selection.getContent()), e.clipboardData.setData("text/plain", s.selection.getContent({format: "text"})), m(!0))
        }))
      }
      ...
      function L() {
        c() < 9 && (ee.addNodeFilter("noscript", function (e) {
          ...
          for (var t = e.length, n, o, a; t--;)n = e[t], o = e[t].firstChild, o ? o.value = i.decode(o.value) : (a = n.attributes.map["data-mce-innertext"],
          a && (n.attr("data-mce-innertext", null), o = new r("#text", 3), o.value = a, o.raw = !0, n.append(o)))
        }))
      }
      ...
      var Y = a.each, K = s.$, G = e.BACKSPACE, X = e.DELETE, J = s.dom, Q = s.selection, Z = s.settings, ee = s.parser, te = s.serializer, ne = o.gecko, re = o.ie, ie = o.webkit, oe = "data:text/mce-internal,", ae = re ? "Text" : "URL";
    ...
    function a(e) {
      ...
      c = i(), s({
        ...
        e.addMenuItem(n, {
          text: t[0], icon: n, shortcut: t[2], cmd: t[1]
        })
  ...
  }),a([l, c, u, d, f, p, h, m, g, y, b, C, x, _, E, N, k, S, T, R, A, B, D, L, M, H, O, I, F, z, W, V, U, $, q, j, Y, K, G, X, J, Q, Z, ee, te, ne, re, ie, oe, ae, se, le, ce, ue, de, fe, pe, he, me, ge, ve, ye, be, Ce, xe, we, _e, Ee, Ne, ke, Se, Te, Re, Ae, Be, De, Le, Me, He, Pe, Oe, Ie, Fe, ze, We, Ve, Ue, $e, qe, je, Ye, Ke, Ge, Xe, Je, Qe, Ze, et, tt, nt, rt, it, ot, at, st])
}(this);