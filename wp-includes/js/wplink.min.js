...
!function (a) {
  ...
  wpLink = {
    ...
    getAttrs: function () {
      return {href: a.trim(h.url.val()), target: h.openInNewTab.prop("checked") ? "_blank" : ""}
    },
    update: function () {
    ...
    setDefaultValues: function () {
      ...
      this.isMCE() ? a = c.selection.getContent() : document.selection && wpLink.range ? a = wpLink.range.text : "undefined" != typeof this.textarea.selectionStart && (a = this.textarea.value.substring(this.textarea.selectionStart, this.textarea.selectionEnd)), h.url.val(a && b.test(a) ? "mailto:" + a : a && d.test(a) ? a.replace(/&amp;|&#0?38;/gi, "&") : ""), h.submit.val(wpLinkL10n.save)
    },
