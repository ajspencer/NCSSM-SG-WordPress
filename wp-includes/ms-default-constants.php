...
function ms_upload_constants() {
    ...
    if (!defined('UPLOADS')) {
        ...
        if ('wp-content/blogs.dir' == UPLOADBLOGSDIR && !defined('BLOGUPLOADDIR')) define('BLOGUPLOADDIR', WP_CONTENT_DIR . "/blogs.dir/{$wpdb->blogid}/files/");
    }
}
...
function ms_cookie_constants() {
     ...
     * @since 1.2.0
     */
    if (!defined('COOKIEPATH')) define('COOKIEPATH', $current_site->path);

    /**
     * @since 1.5.0
     */
    if (!defined('SITECOOKIEPATH')) define('SITECOOKIEPATH', $current_site->path);
    ...
    if (!defined('COOKIE_DOMAIN') && is_subdomain_install()) {
        if (!empty($current_site->cookie_domain)) define('COOKIE_DOMAIN', '.' . $current_site->cookie_domain); else
...
function ms_file_constants() {
     ...
     * @since 3.0.0
     */
    if (!defined('WPMU_SENDFILE')) define('WPMU_SENDFILE', false);

    /**
     * Optional support for X-Accel-Redirect header
     * @since 3.0.0
     */
    if (!defined('WPMU_ACCEL_REDIRECT')) define('WPMU_ACCEL_REDIRECT', false);
}
