...
function get_the_author($deprecated = '') {
    ...
    if (!empty($deprecated)) _deprecated_argument(__FUNCTION__, '2.1');
...
function the_author($deprecated = '', $deprecated_echo = true) {
    if (!empty($deprecated)) _deprecated_argument(__FUNCTION__, '2.1');
    if ($deprecated_echo !== true) _deprecated_argument(__FUNCTION__, '1.5', __('Use <code>get_the_author()</code> instead if you do not want the value echoed.'));
    if ($deprecated_echo) echo get_the_author();
...
function get_the_author_meta($field = '', $user_id = false) {
    ...
    if (in_array($field, array('login', 'pass', 'nicename', 'email', 'url', 'registered', 'activation_key', 'status'))) $field = 'user_' . $field;
...
function get_author_posts_url($author_id, $author_nicename = '') {
    ...
    if (empty($link)) {
        ...
        if ('' == $author_nicename) {
            ...
            if (!empty($user->user_nicename)) $author_nicename = $user->user_nicename;
        }
