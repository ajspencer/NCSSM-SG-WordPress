    ...
    <div id="content">
        ...
        <form action="admin-post.php" method="post" id="<?php echo $namespace; ?>-support-form">
            ...
            <div class="widget">
                ...
                <p>Please make sure to open a support ticket via WP BackItUp <a
                        href="https://www.wpbackitup.com/support" target="_blank">support portal.</a> before using this
                    form.</p>

                <p>
                    <em><?php _e('The ticket id you receive from your support request should be entered in the ticket id field below.', $namespace); ?></em>
                </p>

                <p><input <?php echo($disabled); ?> type="text" name="support_email"
                                                    value="<?php echo $support_email; ?>" size="30"
                ...
                <p><input <?php echo($disabled); ?> type="text" name="support_ticket_id" value="" size="30"
                ...
                <p><textarea <?php echo($disabled); ?> name="support_body" rows="4" cols="50"
                                                       style="width:450px;height:150px;"
                                                       placeholder="problem description or additional information"><?php echo get_transient('support_body'); ?></textarea>
                    <?php
                ...
                <div class="submit"><input <?php echo($disabled); ?> type="submit" name="send_ticket"
                                                                     class="button-primary"
                                                                     value="<?php _e("Send", $namespace) ?>"/>

                    <?php if (!$license_active && !$is_lite_registered) : ?>
                        <span
                            style="color:red">* Please register your version of WP BackItUp for access to support.</span>
                    <?php endif; ?>
