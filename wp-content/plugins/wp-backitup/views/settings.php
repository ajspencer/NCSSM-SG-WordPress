    ...
    <div id="content">
        ...
        <form action="admin-post.php" method="post" id="<?php echo $namespace; ?>-form">
            ...
            <div class="widget">
                ...
                <p><input type="text" name="data[notification_email]" value="<?php echo $this->notification_email(); ?>"
                          size="30"></p>

                <div class="submit"><input <?php echo($disabled); ?> type="submit" name="Save_Email"
                                                                     class="button-primary"
                                                                     value="<?php _e("Save", $namespace) ?>"/>
            ...
            <div class="widget">
                ...
                <p>Many hosts limit the amount of space that you can take up on their servers. This option tells
                    WP BackItUp the maximum number of backup archives that should remain on your hosts server. Don't
                    worry, we will
                    always remove the oldest backup archives first.</p>

                <p><input type="text" name="data[backup_retained_number]"
                          value="<?php echo $this->backup_retained_number(); ?>" size="4"></p>

                <div class="submit"><input type="submit" name="Save_Retention" class="button-primary"
                                           value="<?php _e("Save", $namespace) ?>"/></div>
                <?php
            ...
            <div class="widget">
                ...
                <p><input type="radio" name="data[logging]" value="true" <?php if ($this->logging()) echo 'checked'; ?>>
                    <label><?php _e('Yes', $namespace); ?></label></p>

                <p><input type="radio" name="data[logging]"
                          value="false" <?php if (!$this->logging()) echo 'checked'; ?>>
                    <label><?php _e('No', $namespace); ?></label></p>

                <p><?php _e('This option should only be turned on when troubleshooting issues with WPBackItUp support.', $namespace); ?></p>

                <p class="submit"><input type="submit" name="Save_Logging" class="button-primary"
                                         value="<?php _e("Save", $namespace) ?>"/></p>
            </div>
            ...
            <div class="widget">
                ...
                <input name="data[backup_batch_size]" id="wpbackitup_batch_size" type="text" size="2"
                       value="<?php echo $backup_batch_size; ?>"/>
                <label> Backup batch size</label>

                <p class="submit"><input type="submit" name="Save_AdvancedSettings" class="button-primary"
                                         value="<?php _e("Save", $namespace) ?>"/>
                    <?php
            ...
            <?php if (WP_DEBUG === true) : ?>
                <div class="widget">
                    ...
                    <div id="php"><p>Debugging is turned on in your wp-config.php file and should only be used when
                            troubleshooting issues on your site.</p></div>
                </div>
            <?php endif; ?>
