    ...
    public function mysqldump_export($sql_file_path, $with_mysqlpath = false) {
        ...
        if (exec('echo EXEC') == 'EXEC') {
            try {
                ...
                $command .= ' --user=' . $db_user . ' --password=' . $db_pass . ' ' . $db_name . ' ' . $tables . ' > "' . $sql_file_path . '"';
...
//			}
    ...
    public function run_sql_exec($sql_file, $with_mysqlpath = false) {
        ...
        try {
            ...
            $command .= ' --user=' . $db_user . ' --password=' . $db_pass . ' --database=' . $db_name . ' --execute="SOURCE ' . $sql_file . '"';
