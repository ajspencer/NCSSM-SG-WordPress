...
class acf_upgrade {
    ...
    */
    ...
    function upgrade_ajax() {
        ...
        // vars
        $return = array('status' => false, 'message' => "", 'next' => false,);
        ...
        switch ($_POST['version']) {
            ...
            *--------------------*/
            ...
            case '3.0.0':
                ...
                // get acf's
                $acfs = get_posts(array('numberposts' => -1, 'post_type' => 'acf', 'orderby' => 'menu_order title', 'order' => 'asc', 'suppress_filters' => false,));
                ...
                $return = array('status' => true, 'message' => "Migrating Options...", 'next' => '3.0.0 (step 2)',);
            ...
            *--------------------*/
            ...
            case '3.0.0 (step 2)':
                ...
                $return = array('status' => true, 'message' => "Migrating Location Rules...", 'next' => '3.0.0 (step 3)',);
            ...
            *--------------------*/
            ...
            case '3.0.0 (step 3)':
                ...
                $return = array('status' => true, 'message' => $message, 'next' => '3.0.0 (step 4)',);
            ...
            *--------------------*/
            ...
            case '3.0.0 (step 4)':
                ...
                $return = array('status' => true, 'message' => $message, 'next' => '3.1.8',);
            ...
            *--------------------*/
            ...
            case '3.1.8':
                ...
                $return = array('status' => true, 'message' => $message, 'next' => '3.2.5',);
            ...
            *--------------------*/
            ...
            case '3.2.5':
                ...
                $return = array('status' => true, 'message' => $message, 'next' => '3.3.3',);
            ...
            */
            ...
            case '3.3.3':
                ...
                $return = array('status' => true, 'message' => $message, 'next' => '3.4.1',);
            ...
            */
            ...
            case '3.4.1':
                ...
                $return = array('status' => true, 'message' => $message, 'next' => false,);
