...
class acf_everything_fields {
    ...
    */
    ...
    function __construct() {
        ...
        $this->data = array('page_id' => '', // a string used to load values
            'metabox_ids' => array(), 'page_type' => '', // taxonomy / user / media
            ...
            foreach ($acfs as $acf) {
                ...
                if (is_array($fields)) {
                    foreach ($fields as $i => $field) {
                        ...
                        $form_fields[$field['name']] = array('label' => $field['label'], 'input' => 'html', 'html' => $html);
...
*/
    ...
    *-------------------------------------------------------------------------------------*/
    ...
    function acf_everything_fields() {
        // defaults
        $defaults = array('metabox_ids' => '', 'page_type' => '', 'page_action' => '', 'option_name' => '',);
    ...
    */
    ...
    function delete_term($term, $tt_id, $taxonomy, $deleted_term) {
        ...
        $values = $wpdb->query($wpdb->prepare("DELETE FROM $wpdb->options WHERE option_name LIKE %s", '%' . $taxonomy . '_' . $term . '%'));
    }
