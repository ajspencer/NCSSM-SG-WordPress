...
class acf_field_group {
    ...
    */
    ...
    function get_field_groups($array) {
        ...
        // get acf's
        $posts = get_posts(array('numberposts' => -1, 'post_type' => 'acf', 'orderby' => 'menu_order title', 'order' => 'asc', 'suppress_filters' => false,));
        ...
        if ($posts) {
            foreach ($posts as $post) {
                ...
                $array[] = array('id' => $post->ID, 'title' => $post->post_title, 'menu_order' => $post->menu_order,);
    ...
    */
    ...
    function admin_enqueue_scripts() {
        ...
        // custom scripts
        wp_enqueue_script(array('acf-field-group',));


        // custom styles
        wp_enqueue_style(array('acf-global', 'acf-field-group',));
    ...
    */
    ...
    function admin_head() {
        ...
        // l10n
        $l10n = array('move_to_trash' => __("Move to trash. Are you sure?", 'acf'), 'checked' => __("checked", 'acf'), 'no_fields' => __("No toggle fields available", 'acf'), 'title' => __("Field group title is required", 'acf'), 'copy' => __("copy", 'acf'), 'or' => __("or", 'acf'), 'fields' => __("Fields", 'acf'), 'parent_fields' => __("Parent fields", 'acf'), 'sibling_fields' => __("Sibling fields", 'acf'), 'hide_show_all' => __("Hide / Show All", 'acf'));
    ...
    */
    ...
    function ajax_render_options() {
        // vars
        $options = array('field_key' => '', 'field_type' => '', 'post_id' => 0, 'nonce' => '');
        ...
        // render options
        $field = array('type' => $options['field_type'], 'name' => $options['field_key']);
    ...
    function ajax_render_location($options = array()) {
        ...
        switch ($options['param']) {
            ...
            case "post_status" :
                ...
                $choices = array('publish' => __('Publish'), 'pending' => __('Pending Review'), 'draft' => __('Draft'), 'future' => __('Future'), 'private' => __('Private'), 'inherit' => __('Revision'), 'trash' => __('Trash'));
