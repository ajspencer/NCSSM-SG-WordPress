...
class acf_field_user extends acf_field {
    ...
    */
    ...
    function __construct() {
        ...
        $this->defaults = array('role' => 'all', 'field_type' => 'select', 'allow_null' => 0,);
    ...
    */
    ...
    function create_field($field) {
        ...
        // options
        $options = array('post_id' => get_the_ID(),);
    ...
    function create_options($field) {
        ...
        <tr class="field_option field_option_<?php echo $this->name; ?>">
            ...
            <td>
                ...
                do_action('acf/create_field', array('type' => 'select', 'name' => 'fields[' . $key . '][role]', 'value' => $field['role'], 'choices' => $choices, 'multiple' => '1',));
        ...
        <tr class="field_option field_option_<?php echo $this->name; ?>">
            ...
            <td>
                <?php
                do_action('acf/create_field', array('type' => 'select', 'name' => 'fields[' . $key . '][field_type]', 'value' => $field['field_type'], 'choices' => array(__("Multiple Values", 'acf') => array(//'checkbox' => __('Checkbox', 'acf'),
                    'multi_select' => __('Multi Select', 'acf')), __("Single Value", 'acf') => array(//'radio' => __('Radio Buttons', 'acf'),
