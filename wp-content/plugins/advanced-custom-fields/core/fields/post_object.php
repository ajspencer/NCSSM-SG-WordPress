...
class acf_field_post_object extends acf_field {
    ...
    */
    ...
    function __construct() {
        ...
        $this->defaults = array('post_type' => array('all'), 'taxonomy' => array('all'), 'multiple' => 0, 'allow_null' => 0,);
    ...
    */
    ...
    function create_field($field) {
        ...
        // vars
        $args = array('numberposts' => -1, 'post_type' => null, 'orderby' => 'title', 'order' => 'ASC', 'post_status' => array('publish', 'private', 'draft', 'inherit', 'future'), 'suppress_filters' => false,);
        ...
        if (!in_array('all', $field['taxonomy'])) {
            ...
            foreach ($taxonomies as $k => $v) {
                $args['tax_query'][] = array('taxonomy' => $k, 'field' => 'id', 'terms' => $v,);
            }
        }
    ...
    function create_options($field) {
        ...
        <tr class="field_option field_option_<?php echo $this->name; ?>">
            ...
            <td>
                ...
                do_action('acf/create_field', array('type' => 'radio', 'name' => 'fields[' . $key . '][allow_null]', 'value' => $field['allow_null'], 'choices' => array(1 => __("Yes", 'acf'), 0 => __("No", 'acf'),), 'layout' => 'horizontal',));
        ...
        <tr class="field_option field_option_<?php echo $this->name; ?>">
            ...
            <td>
                ...
                do_action('acf/create_field', array('type' => 'radio', 'name' => 'fields[' . $key . '][multiple]', 'value' => $field['multiple'], 'choices' => array(1 => __("Yes", 'acf'), 0 => __("No", 'acf'),), 'layout' => 'horizontal',));
    ...
    */
    ...
    function format_value_for_api($value, $post_id, $field) {
        ...
        if (is_array($value)) {
            ...
            $posts = get_posts(array('numberposts' => -1, 'post__in' => $value, 'post_type' => apply_filters('acf/get_post_types', array()), 'post_status' => array('publish', 'private', 'draft', 'inherit', 'future'),));
