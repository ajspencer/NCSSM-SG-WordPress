...
class acf_field_true_false extends acf_field {
    ...
    */
    ...
    function __construct() {
        ...
        $this->defaults = array('default_value' => 0, 'message' => '',);
    ...
    */
    ...
    function create_options($field) {
        ...
        <tr class="field_option field_option_<?php echo $this->name; ?>">
            ...
            <td>
                <?php
                do_action('acf/create_field', array('type' => 'text', 'name' => 'fields[' . $key . '][message]', 'value' => $field['message'],));
                ?>
            </td>
        </tr>
        <tr class="field_option field_option_<?php echo $this->name; ?>">
            ...
            <td>
                ...
                do_action('acf/create_field', array('type' => 'true_false', 'name' => 'fields[' . $key . '][default_value]', 'value' => $field['default_value'],));
