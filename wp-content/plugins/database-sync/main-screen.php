<div class="wrap">
    ...
    <table class="form-table">
                    ...
                    <?php foreach ($tokens as $url => $secret): ?>
                        <form method="post" action="">
                            ...
                            <p>
                                ...
                                <a class="button"
                                   href="<?php echo htmlspecialchars(dbs_url(array('dbs_action' => 'sync', 'url' => $url))); ?>">Sync...</a>
        ...
        <tr valign="top">
            ...
            <td>
                <a href="<?php echo admin_url('admin-ajax.php?action=dbs_pull&dump=manual'); ?>" target="_blank"
                   class="button">Dump</a>
            </td>
        </tr>
    </table>
